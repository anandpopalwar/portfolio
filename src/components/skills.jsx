    ...
    >
      ...
      <div className="grid  grid-cols-3  sm:grid-cols-3 font-medium  md:grid-cols-3 lg:grid-cols-6 gap-4 text-center my-4  mx-auto ">
        ...
        <div className="grid place-content-center">
          <img
            src={CSS}
            className="w-20 grid place-content-center hover:transition ease-in-out    mx-auto     hover:-translate-y-1 hover:scale-110  duration-300"
            alt="css"
          />
          <h3>CSS3</h3>
        </div>
        ...
        <div className="grid place-content-center">
          <img
            src={Bootstrap}
            className="w-20 grid  justify-center hover:transition ease-in-out   mx-auto    hover:-translate-y-1 hover:scale-110  duration-300"
            alt="tailwind"
          />
