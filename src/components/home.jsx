    ...
    >
      <div className="homeleft   ">
        <div>
          ...
          <div className=" my-2 ">
            <p className=" font-mono text-base sm:text-base md:text-xl lg:text-xl  ">
        ...
        <div className="grid grid-rows-1 gap-2">
          <Link
            className="cursor-pointer sm:text-base bg-stone-900 rounded-2xl px-8 py-2 w-48 text-neutral-200  flex text-lg uppercase hover:text-rose-400 gap-2"
            to="contact"
            spy={true}
            smooth={true}
            offset={-100}
